...
c.  *Cover Page*. Your technical quotation and price quotation must include a cover page. In most instances, the cover page shall be no more than one (1) page. Your cover page is not included as part of your 3-page limitation. The following introductory information is required on the first page of each section:
...
d.  *Technical Understanding and Approach.* The offeror shall succinctly describe level of knowledge, technical expertise and overall understanding of the requirement as set forth in the SOO. Technical understanding and approach   is included as part of your 3-page limitation. Use of the Technical Approach Template (Attachment A) is required.
